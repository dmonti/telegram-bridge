...
class TelegramBridge:
    ...
    async def start(self):
        ...
        print(f"TelegramBridge looking group {source_entity.title} for messages")
        while self.running:
    ...
    async def send_message_channel(self, message, channel: Channel):
        ...
        print(f"New message #{message.id} sent to {channel.title}")
